...
# BASE_DIR pointe sur gestion_coiffure
BASE_DIR = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': (
        'rest_framework.authentication.SessionAuthentication',  # permet l'auth Django
...
# settings.py
MAX_POSTE = 5  # nombre maximum de clients EN_COURS simultanément
